...
- a. Housing adequate for health and dignity
- b. Comprehensive healthcare, including mental healthcare
- c. Education from early childhood through advanced training
- d. Sustenance sufficient for health
- e. Legal representation and access to justice
- f. Access to essential infrastructure: power, water, internet, and utilities
- g. Accessibility accommodations proportional to need
...
Every citizen may, on any matter, either vote directly or delegate their vote to a proxy of their choosing. A proxy carries the full weight of all votes delegated to them. Delegation may be revoked at any time. A citizen who neither votes nor delegates has no representation on that matter.

### Section 2. Graded Consensus
Votes on all matters are expressed on a graded scale, from strong support through acceptance and toleration to objection and block. Consensus exists when the distribution of responses is cohesive — clustering in a recognizable direction, whether that direction is positive, negative, or neutral. Consensus fails when the distribution is polarized — responses split between extremes with no middle ground. A polarized response indicates a divisive proposal that must be revised. Simple majority rule is not legitimate governance under this constitution. The measure of consensus is cohesion, not count.

### Section 2a. Algorithmic Determination
Cohesion and polarity are determined by mathematical analysis of vote distribution shape. The algorithm is public, its implementation is open, and its application is auditable by the tribunal system. No human judgment determines whether consensus has been reached — the math does. The specific algorithm is a matter of commonwealth policy, not constitutional prescription, and may be refined over time through the standard governance process.
...
- d. Any form of torture or degrading treatment
- e. Denial of healthcare, sustenance, or human contact
- f. Indefinite detention without review
...
- a. Torture of prisoners of war or detainees
- b. Deliberate targeting of civilians
- c. Use of cruelty as a military strategy or tactic
- d. Any practice prohibited by Article VIII, Section 4
